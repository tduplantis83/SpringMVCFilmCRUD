						...
						<form:form action="filmUpdate.do" method="POST" items="${film}">
							<div class="form-group">
								<input type="hidden" name="id" value="${film.id }" /> <label
									...
									name="rentalRate" class="form-control"
									value="${film.rentalRate}"> <br> <label
									for="length">Length</label> <input type="text" name="length"
									class="form-control" value="${film.length}"> <br>
								<label for="replacementCost">Replacement Cost</label> <input
									...
									for="rating">Rating</label> <select class="form-control"
									...
									<option>R</option>
									<option>NC17</option>
								</select> <br> <label for="specialFeatures">Special Features</label><select
									multiple class="form-control" id="specialFeatures"
